...
function UpdateBanners() {
  ...
  useEffect(() => {
    const fetchBanner = async () => {
      try {
        const response = await axios.get(`/api/users/update-banner/${id}`);
        const data = response.data;
  
        setFormData(data);
  
        if (data.desktopImage) {
          setDesktopImagePreview(data.desktopImage);
        }
  
        if (data.mobileImage) {
          setMobileImagePreview(data.mobileImage);
        }
  ...
  const handleChange = async (e) => {
    ...
    if (type === "file") {
      ...
      if (name === "position") {
        updatedFormData[name] = value === "" ? null : parseInt(value, 10);
      } else {
  ...
  const handleSubmit = async (e) => {
    ...
    if (isValid) {
      try {
        ...
        const response = await axios.put(`/api/users/update-banner-data/${id}`, formDataToSend, {
          headers: {
  ...
  return (
    <div className="banner-box px-0 px-md-4 px-2 pt-md-2 pb-md-3 pb-0 pt-3">
          ...
          <Form onSubmit={handleSubmit} encType="multipart/form-data">
            <div className="bannerLayout-Row">
              <div className="bannerLayout-col row">
                <div className="d-flex flex-column mb-md-3 mb-2 colWide col-md-6" controlId="title">
                ...
                <div className="d-flex flex-column mb-md-3 mb-2 colWide col-md-6" controlId="bannerClass">
                  <Form.Label>Banner Class:</Form.Label>
                  <Form.Control
                    type="text"
                    name="bannerClass"
                ...
                <div className="d-flex flex-column mb-md-3 mb-2 colWide col-md-6" controlId="imageURL">
                ...
                <div className="d-flex flex-column mb-md-3 mb-2 colWide col-md-6" controlId="startDate">
                ...
                <div className="d-flex flex-column mb-md-3 mb-2 colWide col-md-6" controlId="endDate">
                ...
                <div className="d-flex flex-column mb-md-3 mb-2 colWide col-md-6" controlId="platform">
                ...
                <div className="d-flex flex-column mb-md-3 mb-2 colWide col-md-6" controlId="page">
                ...
                <div className="d-flex flex-column mb-md-3 mb-2 colWide col-md-6" controlId="placement">
                ...
                {showDropdowns.position && (
                  <div className="d-flex flex-column mb-md-3 mb-2 colWide col-md-6" controlId="position">
                ...
                {showDropdowns.lang && (
                  <div className="d-flex flex-column mb-md-3 mb-2 colWide col-md-6" controlId="lang">
                ...
                <div className="d-flex flex-column mb-md-3 mb-2 colWide col-md-6" controlId="desktopImage">
